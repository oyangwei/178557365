//
//  YW_ActivityTestStyleViewController_05.m
//  TM_VB_1v0
//
...
@interface YW_ActivityTestStyleViewController_05 ()
{
    BOOL isFullScreen;
}
...
/** forthBtn */
@property(strong, nonatomic) UIButton *forthBtn;
...
@implementation YW_ActivityTestStyleViewController_05
...
-(void)viewDidLayoutSubviews
{
    ...
    [_thirdBtn mas_updateConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(!isFullScreen? IconWidth:FullScreeIconWidth);
        make.height.mas_equalTo(!isFullScreen? IconWidth:FullScreeIconWidth);
    }];
    
    [_forthBtn mas_updateConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(!isFullScreen? IconWidth:FullScreeIconWidth);
        make.height.mas_equalTo(!isFullScreen? IconWidth:FullScreeIconWidth);
    }];
...
-(void)setupContentView
{
    ...
    [thirdBtn setImage:[UIImage imageNamed:@"thirdBtn"] forState:UIControlStateNormal];
    
    UIButton *forthBtn = [[UIButton alloc] init];
    [forthBtn setImage:[UIImage imageNamed:@"forthBtn"] forState:UIControlStateNormal];
    ...
    [contentView addSubview:thirdBtn];
    [contentView addSubview:forthBtn];
    ...
    [firstBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.trailing.equalTo(contentView.mas_centerX).offset(-30);
        make.bottom.equalTo(contentView.mas_centerY).offset(-60);
        make.width.mas_equalTo(IconWidth);
        make.height.mas_equalTo(IconWidth);
    }];
    
    [secondBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.equalTo(contentView.mas_centerX).offset(30);
        make.bottom.equalTo(contentView.mas_centerY).offset(-60);
        make.width.mas_equalTo(IconWidth);
        make.height.mas_equalTo(IconWidth);
    }];
    ...
    [forthBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.equalTo(contentView.mas_centerX).offset(30);
        make.centerY.equalTo(contentView.mas_centerY).offset(30);
        make.width.mas_equalTo(IconWidth);
        make.height.mas_equalTo(IconWidth);
