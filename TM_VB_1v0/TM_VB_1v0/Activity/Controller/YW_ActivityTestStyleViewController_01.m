//
//  YW_ActivityTestStyleViewController_01.m
//  TM_VB_1v0
//
...
@interface YW_ActivityTestStyleViewController_01 ()
{
    BOOL isFullScreen;
}
...
@implementation YW_ActivityTestStyleViewController_01
...
-(void)viewDidLayoutSubviews
{
    ...
    [_wifiBtn mas_updateConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(!isFullScreen? IconWidth:FullScreeIconWidth);
        make.height.mas_equalTo(!isFullScreen? IconWidth:FullScreeIconWidth);
    }];
...
-(void)setupContentView
{
    ...
    [wifiBtn setImage:[UIImage imageNamed:@"wifiBtn"] forState:UIControlStateNormal];
    ...
    [fullScreenBtn setImage:[UIImage imageNamed:@"exit_full_screen"] forState:UIControlStateSelected];
    ...
    [contentView addSubview:wifiBtn];
    ...
    [wifiBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(contentView.mas_centerX);
        make.top.equalTo(secondBtn.mas_bottom).offset(60);
        make.width.mas_equalTo(IconWidth);
        make.height.mas_equalTo(IconWidth);
    }];
