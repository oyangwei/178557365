...
#define CurrentTitle @"<<     Shop     >>"

@interface YW_ShopViewController () <MJCSlideSwitchViewDelegate, UIPopoverPresentationControllerDelegate, UIScrollViewDelegate, UISearchBarDelegate, UITextFieldDelegate>
{
...
@implementation YW_ShopViewController
...
-(void)setupMenuBar
{
    ...
    [menuRightMask setImage:[UIImage imageNamed:RightTabMaskArrow]];
...
- (void)title_scrollView:(UIScrollView *)scrollView
{
    ...
    [self.tabRightMask setImage:tabBarOffset.x < scrollView.contentSize.width - scrollView.width ?[UIImage imageNamed:RightMenuMaskArrow]:NULL];
}
