...
- (IBAction)confirmClick:(id)sender {
    ...
    [[NSUserDefaults standardUserDefaults] setValue:self.Name01.text forKey:@"LocalName01"];
    [[NSUserDefaults standardUserDefaults] setValue:self.UUIDTextField02.text forKey:@"UUID02"];
    [[NSUserDefaults standardUserDefaults] setValue:self.Name02.text forKey:@"LocalName02"];
    [[NSUserDefaults standardUserDefaults] setValue:self.UUIDTextField03.text forKey:@"UUID03"];
    [[NSUserDefaults standardUserDefaults] setValue:self.Name03.text forKey:@"LocalName03"];
    [[NSUserDefaults standardUserDefaults] setValue:self.UUIDTextField04.text forKey:@"UUID04"];
    [[NSUserDefaults standardUserDefaults] setValue:self.Name04.text forKey:@"LocalName04"];
...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [self.Name01 resignFirstResponder];
    [self.UUIDTextField02 resignFirstResponder];
    [self.Name02 resignFirstResponder];
    [self.UUIDTextField03 resignFirstResponder];
    [self.Name03 resignFirstResponder];
    [self.UUIDTextField04 resignFirstResponder];
    [self.Name04 resignFirstResponder];
}
