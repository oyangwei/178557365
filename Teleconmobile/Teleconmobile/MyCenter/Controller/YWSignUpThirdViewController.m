...
@interface YWSignUpThirdViewController () <UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource>
...
@implementation YWSignUpThirdViewController
...
//    [firstQuestionView addGestureRecognizer:tapGestureRecognizer];
    ...
    firstAnswerTextField.placeholder = @"Please Input Password";
    ...
    secondAnswerTextField.placeholder = @"Please Input Password";
    ...
    thirdAnswerTextField.placeholder = @"Please Input Password";
